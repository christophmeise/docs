...
2. Under **Connections**, click **Add WhatsApp Connection**.
...
You can manage connections anytime from your **Settings → Personal Brand → Connections**.
...
**Example workflow for updating your Whatsapp Connection:**
