...
Clicking any of these suggestions will open a post draft ready to be published, so you can schedule or tweak them right away.
...
- **Colored tags** match the post formats in your [content strategy](/content-strategy/content-strategy). You can click any suggestion to instantly open related draft posts and schedule one with a few clicks
