...
## 2. Finish Onboarding & Select Your Plan
...
<Steps>
  <Step title="Add information to your Knowledge Base">
    ...
    **Add at least two items to complete your basic setup**: we recommend starting with personal stories, lessons learned, frameworks, or any insights that reflect your career, expertise, and perspective.
    ...
    Read more about what to upload to the Knowledge Base [here →](/knowledge/content-sources)
  </Step>
...
<CardGroup cols={2}>
  <Card icon="note-sticky" title="Create a Single Post">
    - From [<u>audio</u>](/one-post/audio), [<u>text</u>](/one-post/text), or [<u>blank</u>](/one-post/blank).
  </Card>
  <Card icon="notes" title="Create Multiple Posts">
...
![Invitation 2 Jp](/images/invitation-2.jpg)

3. Add the email, assign a Personal Brand (optional), and assign a role:
...
You can manage all invitations, assign Personal Brands or change roles in your Settings → [People](/settings/people).

<Info>
  You can assign multiple users to the same brand, or assign one user to several brands. Inside Settings → [People](/settings/people), go to the **Assign users to projects** section, to manage which brands each user has access to.
</Info>
