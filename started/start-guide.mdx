...
1. Create your personal brand, [connect it with LinkedIn](/account/li-connection), and install the [Chrome Extension](/account/chrome).
...
### Extra Steps for Teams on the Pro or Agency Plan:

1. [Invite members](/team-plan/invite) to your [workspace](/team-plan/workspace).
2. Set up each [member's role](/team-plan/people) within the workspace.
3. Follow the individuals' setup above for each Personal Brand you create.
...
<Tip>
  Learn more about different ways to work as a team in Scripe, in our [Collaboration Workflows article →](/team-plan/workflows)
</Tip>
