...
[<u>Join a live onboarding session</u>](https://lu.ma/scripe) to learn the essentials of Scripe and see demos of our product.

<Tip>
  You can also watch past onboarding sessions on Scripe's [Youtube Channel →](https://www.youtube.com/@Scripe-io)
</Tip>
...
- Name your workspace
- Choose your plan (you can start free)
- Add your personal brand or team members
...
<Info>
  Please make sure you also read our [Teams Set Up Guide, which includes a video explanation →](/team-plan/set-up)
</Info>
...
3. Set up up to 10 [personal brands](/account/personalbrand) and follow the individuals' set up.
