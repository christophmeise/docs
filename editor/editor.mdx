...
<Frame>
  ![5 Post 1](/images/5-post-1.jpg "5 Post 1")
</Frame>
...
<Frame>
  ![5 Post 4](/images/5-post-4.jpg "5 Post 4")
</Frame>
...
<Frame>
  ![5 Post 3](/images/5-post-3.jpg "5 Post 3")
</Frame>

## Using Mentions

In the Scripe Post Editor, you can tag companies and profiles directly in your LinkedIn posts by using mentions.

- Type **@** followed by the company or profile's name.
- A dropdown will appear showing matching results.
- Select the correct one from the list to insert the mention.

### **Can’t find someone when tagging?**

In that case, instead of searching by name, paste their LinkedIn profile URL (starting with linkedin.com/in) directly into the tag field, as shown in the image below:

<Frame>
  ![New Tagging 5](/images/new-tagging-5.jpg "New Tagging 5")
</Frame>

Scripe will recognize the profile and insert the correct tag.

<Check>
  You only need to paste someone’s LinkedIn profile URL the first time you tag them. After they’ve been recognized once, you can simply search for their name in the future, and they’ll appear in the dropdown as usual.
</Check>

For company pages, search using the company’s LinkedIn handle (the last part of its LinkedIn page URL), rather than the company name:

**Example:**

- Company URL: `https://www.linkedin.com/company/acme-company/`
- Search for: `acme-company`

<Note>
  **Note:** This behavior is a limitation of LinkedIn’s API, not Scripe. If someone doesn’t appear when searching by name, using their profile URL is the most reliable way to tag them.
</Note>
...
<Frame>
  ![5 Post 2](/images/5-post-2.jpg "5 Post 2")
</Frame>
...
<Frame>
  ![5 Post 5](/images/5-post-5.jpg "5 Post 5")
</Frame>
