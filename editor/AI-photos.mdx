...
The AI Photos feature allows you to upload your own photos, enabling Scripe to generate high-quality, personalized branding images that resemble you.

## How to Set it Up

1. Go to **Settings** and select the **Personal Brand** you want to train AI Photos for.
2. Under the **AI Photos** section, upload 10–20 photos of yourself (maximum 10 MB each in `.png`, `.jpg`, or `.jpeg` format).
3. For the best results, make sure the photos:
...
<Warning>
  AI image generation isn’t always perfect. Sometimes the results may look a bit off — that’s totally normal! That’s also why Scripe gives you a **generous monthly limit of 30 images**, so you can generate more until you find the perfect fit.
</Warning>
