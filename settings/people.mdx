...
- Change their roles:
  ...
  - **Client** – Reduces Scripe to only **Posts, Calendar, and Analytics**, with only **basic post editing functions**.
...
In Scripe, [billing](/administration/billing) is based on the number of [**Personal Brands**](/account/personalbrand) you manage, not how many people are in your workspace.

That means:

- You can invite as many team members, freelancers, or clients as needed
- Each [Personal Brand](/account/personalbrand) (aka LinkedIn account connected) slot gives you full feature access
