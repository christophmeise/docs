...
In Scripe, a [workspace](/workspace/overview) is your content environment. Each workspace contains one or more [personal brands](/sidebar/home) (the profiles you create and post content for).
