...
6. Enter the user’s email and [assign a role](/team-plan/people) (Admin, Editor, Viewer, Personal Brand or Client)
7. (Optional) Assign a Personal Brand to the user
7. Send the invite

The user will receive an email invitation to join your organization. Once they accept, they’ll appear in the Members tab.

![Invitation Jp](/images/invitation.jpg)

<Info>
  In the Pro & Agency plan, [billing](/administration/billing) is based on the number of [**Personal Brands**](/account/personalbrand) you manage (aka LinkedIn accounts connected), not how many people are in your workspace. So you can invite as many team members as needed.
</Info>

<Note>
  Alternatively, you can click on your worspace name at the top left corner, and click **Invite Members**.
</Note>
