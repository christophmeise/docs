...
description: "Get a full overview of LinkedIn performance with Scripe’s Analytics Dashboard."
icon: "chart-user"
---
...
1. **Select Personal Brands to compare:** Use the checkboxes at the top to choose which Personal Brands’ data you want to include in your view.
